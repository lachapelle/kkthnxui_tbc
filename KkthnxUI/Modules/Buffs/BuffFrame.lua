...
BuffsAnchor:SetWidth((15 * C["Auras"].buffsize) + 42)
BuffsAnchor:SetHeight((C["Auras"].buffsize * 2) + 3)
...
for i = 1, 2 do
	...
	button:SetScale(1)
	button:SetWidth(C["Auras"].buffsize)
	button:SetHeight(C["Auras"].buffsize)
